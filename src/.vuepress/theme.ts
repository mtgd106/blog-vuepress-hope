...
export default hopeTheme({
  // 页面信息展示 作者、分类、标签、字数、预计阅读时间
  pageInfo: ["Author","Category","Tag","Word","ReadingTime"],

  hostname: "https://mtgd106.github.io",
  breadcrumb: false,
  // 是否显示编辑此页链接
  editLink: false,
  author: {
  ...
  //iconAssets: "fontawesome-with-brands",  //at.alicdn.com/t/c/font_2922463_kweia6fbo9.css
  iconAssets: "//at.alicdn.com/t/font_2410206_vuzkjonf4s9.css",


  logo: "/logo.svg",

  repo: "mtgd106/blog-vuepress-hope",
  ...
  footer: "邮箱:zhao_long_106@163.com",
  ...
  blog: {
    ...
    name: "北斗星司",
    avatar: "头像.svg",
    description: "Java入门级选手",
    // 时间轴的顶部文字
    timeline: "更新日记",
    // 每页显示的文章数量，默认为10
    articlePerPage: 10,
    medias: {
      QQ: "http://wpa.qq.com/msgrd?v=3&uin=1487722388&site=qq&menu=yes",
      GitHub: "https://github.com/mtgd106",
      Email: "mailto:zhao_long_106@163.com",
  ...
  */
  ...
  plugins: {
    ...
    // 版权信息，当用户复制博客中的内容时，自动生成一段版权信息到剪切板中。
    // 也可以禁止用户复制某些文章中的内容
    copyright: {
      author: "北斗星司",
      // 触发长度
      ...
      // 允许复制的最大长度
      maxLength: 600,
      canonical: "https://github.com/mtgd106/blog-vuepress-hope",
      // 全局应用
      global: true,
    },
